...
public class ApiGatewayProxyRequest {
  ...
  public ApiGatewayProxyRequest setHeaders(Map<String, String> headers) {
    this.headers = headers;
    return this;
  }

  public ApiGatewayProxyRequest setQueryStringParameters(Map<String, String> queryStringParameters) {
    this.queryStringParameters = queryStringParameters;
    return this;
  }

  public ApiGatewayProxyRequest setPathParameters(Map<String, String> pathParameters) {
    this.pathParameters = pathParameters;
    return this;
  }

  public ApiGatewayProxyRequest setStageVariables(Map<String, String> stageVariables) {
    this.stageVariables = stageVariables;
    return this;
  }

  public ApiGatewayProxyRequest setContext(Context context) {
  ...
  public ApiGatewayProxyRequest setBase64Encoded(Boolean base64Encoded) {
