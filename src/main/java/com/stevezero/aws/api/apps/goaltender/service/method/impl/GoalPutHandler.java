 ...
 */
public class GoalPutHandler implements ApiMethodHandler {
  ...
  public ApiGatewayProxyResponse handleRequest(ApiGatewayProxyRequest request,
    ...
    // Pull out the ID.
    ApiResourceId userId = PathIdExtractor.extractIdFromPath(request.getPath(), GoalTenderResourceType.USER);
    ApiResourceId goalId = PathIdExtractor.extractIdFromPath(request.getPath(), GoalTenderResourceType.GOAL);
